...
func (in *ClusterAccessProvider) DeepCopyInto(out *ClusterAccessProvider) {
	*out = *in
	in.Cluster.DeepCopyInto(&out.Cluster)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterAccessProvider.
func (in *ClusterAccessProvider) DeepCopy() *ClusterAccessProvider {
	if in == nil {
		return nil
	}
	out := new(ClusterAccessProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterProfileStatus) DeepCopyInto(out *ClusterProfileStatus) {
	*out = *in
	...
	if in.ClusterAccessProviders != nil {
		in, out := &in.ClusterAccessProviders, &out.ClusterAccessProviders
		*out = make([]ClusterAccessProvider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
